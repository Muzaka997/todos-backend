...
CREATE TABLE `__new_events` (
	...
	`notes` text,
	`created_at` text DEFAULT '2026-07-18T16:08:08.685Z' NOT NULL
);
...
CREATE TABLE `__new_notes` (
	...
	`created_at` text DEFAULT '2026-07-18T16:08:08.685Z' NOT NULL,
	`updated_at` text DEFAULT '2026-07-18T16:08:08.685Z' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_notes`("id", "title", "body", "audio", "pinned", "created_at", "updated_at") SELECT "id", "title", "body", "audio", "pinned", "created_at", "updated_at" FROM `notes`;--> statement-breakpoint
...
CREATE TABLE `__new_users` (
	...
	`created_at` text DEFAULT '2026-07-18T16:08:08.684Z' NOT NULL
);
--> statement-breakpoint
